...
// TAREA FUNCIONES AVANZADAS 1 -- en data.js esta el array
// // Buscar la película cuyo id es 843633 y mostrar su nombre por pantalla.
// let movieSearch = movies.find(Element => Element.id === 843633)
// console.log(movieSearch)

// // Pedir al usuario un nombre de una película y en caso de que se encuentre en el array movies mostrar por pantalla la cantidad de votos que tiene.
// let movieAsk = prompt('decime que peli buscas mostro')
// let movieVoteSearch = movies.filter(movie => {
//   return movie.title.toLowerCase().includes(movieAsk.toLocaleLowerCase())
// })
// console.log(movieVoteSearch[0].id)

// // Fitrar las películas más vistas, es decir, las que superan los 1000 puntos de popularidad.
// let movieFilter = movies.filter(Element => Element.popularity >= 1000 )
// for (let i = 0; i < movieFilter; i++) {
